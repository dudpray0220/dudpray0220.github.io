...
export const resumeData: ResumeData = {
  profile: {
    ...
    about: `커뮤니케이션 능력과 배우려는 태도, 그리고 긍정적인 자세를 바탕으로 성장 중인 프론트엔드 개발자 배영현입니다.
사용자 경험과 성능 최적화에 진심이며, 코드 리뷰를 통한 코드 개선을 좋아합니다.
경제금융에서의 직종전환 그리고 C#에서 프론트엔드로 전환한 과정을 통해 얻은 시야를 바탕으로, 지금은 프론트엔드 분야에서 성장하고자 하는 의지가 큽니다.
앞으로도 팀원들과의 적극적인 소통과 협업을 통해 시너지를 극대화하고, 최고의 사용자 경험을 제공하는 프론트엔드 개발자로 거듭나고자 합니다.`,
  },
  skills: {
